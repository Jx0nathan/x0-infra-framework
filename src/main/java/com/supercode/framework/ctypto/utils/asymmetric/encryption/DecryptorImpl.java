...
import com.supercode.framework.ctypto.utils.asymmetric.IDecryptor;
...
public class DecryptorImpl implements IDecryptor {
    ...
    public DecryptorImpl(String privateKey) {
        try {
            ...
            throw new EncryptionCustomizeException("", e);
        }
    }

    @Override
    public byte[] decrypt(byte[] encryptedData) throws EncryptionCustomizeException {
        try {
            ...
            throw new EncryptionCustomizeException("failed to decrypt the encrypted data", e);
        }
    }
}
