...
import com.supercode.framework.log.filter.Log4j2SampleFilter;
import com.supercode.framework.log.kafka.AdvancedKafkaAppender;
import com.supercode.framework.log.layout.CustomJsonLayout;
...
/**
 * @Author: jonathan.ji
 * @Date: 2022/1/23 20:36
 * @Desc:
 */
public class Log4j2Configuration extends AbstractLogConfiguration {
    ...
    public static Log4j2Configuration createLogConfiguration(ConfigurableEnvironment environment) {
    ...
    private void replaceEventSerializer(Object patternLayOut, Serializer newserializer, Field oldserializer)
            throws Throwable {
        Field modifersField = com.supercode.framework.utils.ReflectionUtils.getModifiersField();
